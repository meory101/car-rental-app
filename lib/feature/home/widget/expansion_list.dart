...
class OrderItemsExpansionPanel {
...
class ExpansionPanelRadio extends OrderItemsExpansionPanel {
...
///  * <https://material.io/design/components/lists.html#types>
class OrderItemExpansionPanelList extends StatefulWidget {
  /// Creates an expansion panel list widget. The [expansionCallback] is
  /// triggered when an expansion panel expand/collapse button is pushed.
  ///
  /// The [children] and [animationDuration] arguments must not be null.
  const OrderItemExpansionPanelList({
    super.key,
    this.children = const <OrderItemsExpansionPanel>[],
  ...
  /// {@end-tool}
  const OrderItemExpansionPanelList.radio({
    super.key,
  ...
  /// fashion to [ListBody].
  final List<OrderItemsExpansionPanel> children;
...
class _ExpansionPanelListState extends State<OrderItemExpansionPanelList> {
  ...
  @override
  void didUpdateWidget(OrderItemExpansionPanelList oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < widget.children.length; index += 1) {
      ...
      final OrderItemsExpansionPanel child = widget.children[index];
